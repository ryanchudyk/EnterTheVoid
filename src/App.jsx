...
const App = () => {
  ...
  useEffect(() => {
    ...
    if (wordsAdded > 0 && stage === 'focus') {
      ...
      const idleDelay = thresholdReached ? 5000 : 20000;
  ...
  // Auto-scroll to keep cursor at fixed position (40% from top)
  useEffect(() => {
    if (stage === 'focus' && textareaRef.current) {
      ...
      if (scrollHeight > clientHeight) {
        // Position cursor line at 40% from top of visible area
        const targetScrollTop = scrollHeight - (clientHeight * 0.4);
